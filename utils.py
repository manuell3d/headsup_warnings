...
def draw_highlight_border(border_thickness, border_color=None):
    ...
    try:
        ...
        print("HeadsUp [draw_highlight_border] Error:")
        traceback.print_exc()
...
def draw_filled_red_circle():
    try:
        ...
        print("HeadsUp [draw_filled_red_circle] Error:")
        traceback.print_exc()
...
def draw_circular_gradient():
    ...
    try:
        ...
        print("[check_object_mismatches] Error:")
        traceback.print_exc()
...
def check_renderlayer_compositing_conditions():
    try:
        ...
        print("HeadsUp [check_renderlayer_compositing_conditions] Error:")
        traceback.print_exc()
        return []
